"""Pack TPD NPZ files into structure.lmdb and manifest files."""
...
def main():
    ...
    npz_paths = sorted((data_dir / "npz").rglob("*.npz"))
    ...
    with multiprocessing.Pool(processes=args.num_workers) as pool:
        ...
        for key, value, metadata in tqdm(
            results, total=len(npz_paths), desc="Writing structure LMDB"
        ):
