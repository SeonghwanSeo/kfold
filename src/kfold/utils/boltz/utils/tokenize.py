...
def tokenize(structure: BoltzStructure) -> Tokenized:
    ...
    for chain in chains:
        ...
        for res in structure.residues[res_start:res_end]:
            ...
            if res["is_standard"]:
                ...
                center = structure.atoms[res["atom_center"]]
                disto = structure.atoms[res["atom_disto"]]
                ...
                token = TokenData(
                    ...
                    cyclic_period=np.zeros_like(chain["sym_id"]),
            ...
            # Non-standard are tokenized per atom
                ...
                atom_data = structure.atoms[atom_start:atom_end]
