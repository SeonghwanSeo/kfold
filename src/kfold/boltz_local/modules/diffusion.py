...
from .utils import LinearNoBias, center_random_augmentation, default, log
...
class OutTokenFeatUpdate(Module):
    ...
    def forward(
        ...
        normed_fourier = (
            self.norm_fourier(fourier_embed).unsqueeze(1).expand(-1, next_a.shape[1], -1)
        )
...
class AtomDiffusion(Module):
    ...
    def sample(
        ...
        **network_condition_kwargs,
        ...
        raise NotImplementedError("Sampling not implemented in this module yet.")
