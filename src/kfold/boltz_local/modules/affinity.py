...
from ..layers.pairformer import PairformerNoSeqModule
from ..modules.encodersv2 import PairwiseConditioning
from ..modules.utils import LinearNoBias
...
class AffinityModule(nn.Module):
    ...
    def forward(
        ...
        lig_mask = (
            feats["affinity_token_mask"].repeat_interleave(multiplicity, 0).to(torch.bool)
        )
