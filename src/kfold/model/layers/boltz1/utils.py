...
def center_random_augmentation(
    ...
    augmentation : bool, optional
        Whether to add rotational and translational augmentation the input, by default
        True
...
class ExponentialMovingAverage:
    ...
    Apache-2.0 license Maintains (exponential) moving average of a set of parameters."""
...
# the following is copied from Torch3D, BSD License, Copyright (c) Meta Platforms, Inc.
# and affiliates.
