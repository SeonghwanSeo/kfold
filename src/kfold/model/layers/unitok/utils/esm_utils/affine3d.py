...
class Rotation(ABC):
    ...
    def tensor(self) -> torch.Tensor:
        # We claim that this should be zero-cost abstraction that returns the raw tensor
        # backing this object. The raw tensor should always have exactly 1 more dim than
        # self.shape, which should be implemented using reshaping
        ...
