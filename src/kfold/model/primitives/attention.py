...
def attention_pair_bias(
    ...
    attn_scale : Optional[float]
        The scaling factor for the query-key dot product, default None
    kernel_backend : str
        Backend for attention with precomputed QKV: PyTorch or cuEquivariance.
    """
    ...
    raise ValueError(
        f"Unsupported attention backend {kernel_backend!r} for precomputed QKV. "
        "Expected 'torch' or 'cuequiv'."
    )
